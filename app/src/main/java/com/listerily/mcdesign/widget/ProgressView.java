...
public class ProgressView extends ProgressBar
{
    ...
    public ProgressView(android.content.Context context, android.util.AttributeSet attrs)
	{
		super(context, attrs);
		mPaint = new Paint();
		mPaint.setStyle(Paint.Style.FILL);
    ...
    public ProgressView(android.content.Context context, android.util.AttributeSet attrs, int defStyleAttr)
	{
